...
.method public openContentUrl(Landroid/net/Uri;)Ljava/io/InputStream;
    ...
    move-result-object v1
    :try_end_77
    .catch Ljava/lang/SecurityException; {:try_start_69 .. :try_end_77} :catch_78
...
.method public openResource(Landroid/net/Uri;)Ljava/io/InputStream;
    ...
    .line 47
    :try_start_2a
    iget-object v5, p0, Lcom/ionicframework/cordova/webview/AndroidProtocolHandler;->context:Landroid/content/Context;
    ...
    iput-object v5, p0, Lcom/ionicframework/cordova/webview/AndroidProtocolHandler;->context:Landroid/content/Context;

    .line 50
    :cond_3a
    iget-object v5, p0, Lcom/ionicframework/cordova/webview/AndroidProtocolHandler;->context:Landroid/content/Context;

    invoke-static {v5, v3, v2}, Lcom/ionicframework/cordova/webview/AndroidProtocolHandler;->getFieldId(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)I

    move-result v2

    .line 51
    iget-object v3, p0, Lcom/ionicframework/cordova/webview/AndroidProtocolHandler;->context:Landroid/content/Context;

    invoke-static {v3, v2}, Lcom/ionicframework/cordova/webview/AndroidProtocolHandler;->getValueType(Landroid/content/Context;I)I
    ...
    const-string v3, "Asset not of type string: "
    ...
    :try_end_68
    .catch Ljava/lang/ClassNotFoundException; {:try_start_2a .. :try_end_68} :catch_91
    .catch Ljava/lang/NoSuchFieldException; {:try_start_2a .. :try_end_68} :catch_7d
    .catch Ljava/lang/IllegalAccessException; {:try_start_2a .. :try_end_68} :catch_69
